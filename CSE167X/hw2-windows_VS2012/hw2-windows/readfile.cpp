			...
			if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#'))
			{
				...
				if (cmd == "light")
				{
					...
					else
					{
						...
						if (validinput)
						{
							const int i = numused * 4;
							lightposn[i] = values[0];
							lightposn[i + 1] = values[1];
							lightposn[i + 2] = values[2];
							lightposn[i + 3] = values[3];

							lightcolor[i] = values[4];
							lightcolor[i + 1] = values[5];
							lightcolor[i + 2] = values[6];
							lightcolor[i + 3] = values[7];
